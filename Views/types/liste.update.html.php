...
<div class="flex flex-col md:flex-row justify-center  md:space-y-0  mt-20">
    ...
    <div class="w-full mr-4 md:w-1/3   bg-gray-200 p-6 rounded-lg dark:bg-gray-600 ">
        <h2 class="text-2xl font-bold mb-6 mt-5 text-purple-900 dark:text-purple-400" ">Modifier Type</h2>

        <form action="<?= WEBROOT ?>" method="post">
            <div class="mb-4">
                <label class="block text-gray-700 dark:text-gray-200 font-medium mb-2">Nom:</label>
                <input value="<?= $typeSelect[0]['nomType'] ?>" type="text" id="libelle" name="nomType"
            ...
            <div class="text-center">
                ...
                <input type="hidden" name="id" value="<?= $typeSelect[0]['idType'] ?>">
